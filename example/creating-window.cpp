...
int main() {
	...
	constexpr Point2d<int> origin{0, 0};

    // Declare all OpenGL Variables
    const std::string VarOurColour = "ourColour";
...
//    std::cout << "Maximum nr of vertex attributes supported: " << nrAttributes << std::endl;
	...
	glViewport(origin.x, origin.y, viewport_width, viewport_height);
	// Register callbacks before render loop initialized
	glfwSetFramebufferSizeCallback(window, framebuffer_size_callback);
    glfwSetInputMode(window, GLFW_CURSOR, GLFW_CURSOR_DISABLED);
    glfwSetCursorPosCallback(window, mouse_callback);
    glfwSetScrollCallback(window, scroll_callback);

    // Z-buffer enable testing
...
//    glFrontFace(GL_CCW);
    ...
    // -------------------------
    Shader ourShader("../../colours.vs", "../../colours.fs");
